...
export default function UserStatus({ user, isLoading }: UserStatusProps) {
  ...
  const onSubmit = (data: UserStatusFormData) => {
    startSavingTransition(async () => {
      ...
      upsertMutation
        ...
        .catch((error) => {
          toast.dismiss();
          logger.error("An error occurred while updating user status", error);
          toast.error("An error occurred while updating user status", error);
        });
    });
  };
